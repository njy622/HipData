...
def green_consume():
    return render_template('/chatbot/01.GreenConsume.html', menu=menu)

@green_service_bp.route('/publictransport')
def public_transport():
    return render_template('/chatbot/02.PublicTransport.html', menu=menu)

@green_service_bp.route('/energysaving')
def envergy_saving():
    return render_template('/chatbot/03.EnergySaving.html', menu=menu)

@green_service_bp.route('/publicbuilding')
def public_building():
    return render_template('/chatbot/04.PublicBuilding.html', menu=menu)