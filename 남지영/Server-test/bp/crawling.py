...
products = [
    ...
    },
    {
        "id": 7,
        "name": "NH농협 국민행복 체크카드",
        "description": "[A-type: 병/의원/산후조리원 3% 할인] || [B-type: 어린이집·유치원 3% | 놀이공원 50% 할인] || [C-type: 국내 가맹점 0.2%~0.5% 적립] || 대중교통 3%·카페 10% 할인 등, 30만원 이상, 없음",
    ...
    },
    {
        ...
        "description": "[A-type: 병/의원/산후조리원 3% 할인] || [B-type: 어린이집·유치원 3% | 놀이공원 50% 할인] || [C-type: 국내 가맹점 0.2%~0.5% 적립] || 대중교통 3%·카페 10% 할인 등, 20만원 이상, 없음",
        "image_url": "../static/img/IBK기업 국민행복 체크카드.png"
    },
    {
        "id": 11,
        "name": "제주 국민행복카드",
        "description": "[A-type: 병/의원/산후조리원 5% 할인] || [B-type: 어린이집·유치원 5% | 놀이공원 50% 할인] || [C-type: 국내 가맹점 0.2%~1.0% 적립] || 공통: 온라인 쇼핑몰/대중교통 5% || 통신요금 1천원 할인 || 카페 20% 할인 등 , 없음, 없음",
